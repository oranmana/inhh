            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group row">
                            <label for="username" class="col-lg-4 col-form-label text-lg-right">User Name</label>
                            ...
                            <div class="col-lg-6 offset-lg-4">
                                <div class="form-check">
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input mr-10" name="remember" {{ old('remember') ? 'checked' : '' }}>
